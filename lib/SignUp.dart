...
class _SignUpState extends State<SignUp> {
  ...
  if(passwordcontroller.text==confirmpasswordcontroller.text)
  {
                ...
                response= await http.post("https://mistcomputerclub.000webhostapp.com/signup.php",body:jsonEncode(data));
                print(response.body);
  ...
  {
        WarningAlertBox(context: context,title: "wait!",messageText:"password and confirm pasword doesn't match." );
  }
  }
  @override
  Widget build(BuildContext context) {
    ...
    children: <Widget>[
      ...
      ListTile(
        title: Text('Item 1',style:TextStyle(fontSize: 30,color: Colors.white),),
        onTap: () {
...
Container(
  ...
  BoxDecoration(
    ...
    image:DecorationImage(image:AssetImage('assets/abstract.jpg'),fit: BoxFit.cover)
   ...
   child: Padding(
         ...
         mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: <Widget>[
              ...
              Text("Sign Up Form",style:GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 30,color: Colors.white,letterSpacing:2,wordSpacing: 10,fontWeight: FontWeight.w200) )),
